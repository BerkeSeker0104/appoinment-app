...
class _EditProductPageState extends State<EditProductPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      await _productUseCases.updateProduct(
        id: widget.product.id,
        name: _nameController.text.trim(),
        description: _descriptionController.text.trim(),
        price: double.parse(_priceController.text.trim()),
        newPictures: _newImages.isNotEmpty ? _newImages : null,
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)!.currentImages,
                        style: AppTypography.body1.copyWith(
                      ...
                      // New Product Images
                      Text(
                        AppLocalizations.of(context)!.addNewImages,
                        style: AppTypography.body1.copyWith(
                          color: AppColors.textPrimary,
                          fontWeight: FontWeight.w600,
                        ),
  ...
  Widget _buildCurrentImages() {
    if (widget.product.pictures.isEmpty) {
      return Container(
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final imageUrl = widget.product.pictures[index];
          return Container(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: AppSpacing.sm),
            Text(
              AppLocalizations.of(context)!.addNewImage,
              style: AppTypography.body1.copyWith(
                color: AppColors.accent,
                fontWeight: FontWeight.w600,
              ),
