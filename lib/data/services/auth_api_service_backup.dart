...
class AuthApiService {
  ...
  Future<User?> getCurrentUser() async {
    try {
      ...
      final userJson = await _apiClient.getUserJson();
      if (userJson != null) {
        try {
          ...
          // Corrupted stored user, fall back to token mapping
        }
      }

      // Backend 'me' endpointi yoksa null dön (login yanıtındaki kullanıcıyı kullanıyoruz)
      return null;
    } catch (e) {
      return null;
    }
